...
public final class Assembler{
    ...
    /**
     Add a partial torus (torus with only one quarter of it's cross-section) to
     the assembly.

     The lower ring and its properties will be ignored and the upper ring from
     the last command will be used if compatible.

     @param sliceCount The number of slices (xy plane) that the torus is divided
    ...
    /**
     ...
     @return A list of buffers with the indices of all vertices of all surfaces.
     */
    ...
    private double[] calculateQuadStripNormal(int index, Ring ring0, Ring ring1, Ring ring2){
        ...
        if(ring1.isVertexNormalCalculated(index)){
            ...
            //If this is the only ring (it has no neighboring rings) then no surface is defined, and also no normal.
            if((ring2 == null) && (ring0 == null)){
                ...
                //If this is the last ring, then the normal is equal for both the first and second ring of the surface.
                if(ring2 == null){
    ...
    /**
     ...
     @param angleIndex  The number of the slice that has to be calculated.
     @param deltaRadius The difference in radius between the bottom and the top
                        of the surface.
     @param deltaHeight The difference in height between the bottom and the top
                        of the surface.
     @param sliceCount  The total number of slices in the surface.
    ...
    private static final class Ring{
        ...
        /**
         If the vertices in this Ring have undergone normal calculation yet, can
         not be reset.
         */
        ...
        /**
         ...
         @param index  The position in the list of Vertex's defining this Ring.
         */
